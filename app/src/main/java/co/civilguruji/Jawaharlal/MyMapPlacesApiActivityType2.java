...
public class MyMapPlacesApiActivityType2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Places.
        Places.initialize(getApplicationContext(),getResources().getString( R.string.google_place_key ));//"AIzaSyCqU-O_Oa5v-O41FLDosBaZQMeyDSEtlfo");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == AUTOCOMPLETE_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
               ...
               // txtView.setText("Place!!: " +place.getName()+",\nID!!: "+place.getId()+ ",\nLatLng!!: " + place.getLatLng()+"   getAddress ,   "+place.getAddress() );
